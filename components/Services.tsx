                ...
                <div className=" grid grid-cols-1 grid-flow-row lg:grid-cols-2 md:grid-cols-2 xl:grid-cols-3  gap-4 ">
                    {elements.map((element, index) => (
                        ...
                        >
                            ...
                            >
                                <div
                                    className="relative top-0 left-0 right-0 bottom-0 h-[60vh] lg:h-100 w-full flex-none bg-cover">
                                    <Image
                                        loading="lazy"
                                ...
                                <div
                                    className=" absolute bottom-0 left-0 h-min w-full pt-8  p-4  flex flex-col justify-center items-start  bg-slate-200 dark:bg-slate-900 bg-opacity-30 dark:bg-opacity-80 backdrop-blur-sm hover:backdrop-blur-md transition-all duration-300 ">
                                    <div
                                        className="text-slate-900 dark:text-white font-normal  mb-2 font-BebasNeue text-3xl ">
                                        {element.title}
                                    </div>
                                    {element.description && (
                                        <p
